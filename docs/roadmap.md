...
- keep this file short so planning entry cost stays low
- put the current roadmap in the active roadmap file
- move completed roadmap generations into `docs/roadmaps/`
