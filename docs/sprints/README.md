...
This directory contains concrete implementation plans for near-term work.

## Current Status

The sprint filenames here are not the execution order by themselves.

The intended reading order is:

1. [phase-1-adaptive-planning.md](phase-1-adaptive-planning.md) — initial product sprint, effectively complete
2. [sprint-2-backend-modularization.md](sprint-2-backend-modularization.md) — engineering sprint, structurally complete
3. [sprint-3-feedback-loop.md](sprint-3-feedback-loop.md) — feedback loop sprint, functionally implemented
4. [sprint-4-goal-aware-planning.md](sprint-4-goal-aware-planning.md) — goal-aware planning sprint, complete
...
9. [sprint-9-app-redesign-and-information-hierarchy.md](sprint-9-app-redesign-and-information-hierarchy.md) — app redesign and information hierarchy sprint, complete
10. [sprint-10-coaching-history-and-revision-timeline.md](sprint-10-coaching-history-and-revision-timeline.md) — coaching history and plan revision visibility sprint, complete
...
- [phase-1-adaptive-planning.md](phase-1-adaptive-planning.md)
- [sprint-2-backend-modularization.md](sprint-2-backend-modularization.md)
- [sprint-3-feedback-loop.md](sprint-3-feedback-loop.md)
- [sprint-4-goal-aware-planning.md](sprint-4-goal-aware-planning.md)
- [sprint-5-planned-to-actual-linking.md](sprint-5-planned-to-actual-linking.md)
...
- [sprint-19-deterministic-athlete-brief-and-goal-aware-coaching-explanations.md](sprint-19-deterministic-athlete-brief-and-goal-aware-coaching-explanations.md)
- [sprint-20-natural-language-goal-capture-and-structured-drafts.md](sprint-20-natural-language-goal-capture-and-structured-drafts.md)
